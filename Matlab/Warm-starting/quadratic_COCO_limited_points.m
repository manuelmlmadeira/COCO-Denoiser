function [visited_points, visited_gradients, s_final] = quadratic_COCO_limited_points(x0, A, b, step_size, tol, nstep_max, mu, sigma, L, npoints)
...
while steps_counter < nstep_max
    ...
    [theta, s_final] = COCO_Denoiser( K, n, L, consulted_gradients, consulted_points, tol );
